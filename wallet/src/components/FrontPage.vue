<h1><a class="header-link" href="/">My Wallet</a></h1>
<template>
  ...
  <div>
    ...
    <h5>History</h5>
      <div class="transaction" v-for="tx in transactionPool" v-bind:key="tx">
      <div class="row">
        <span >TxId: {{ tx.id }}</span>
      </div>
      <div class="row">
        <div class="five columns">
          <div v-for="txIn in tx.txIns" v-bind:key="txIn">
        ...
        <div class="six columns">
          <div class="row" v-for="txOut in tx.txOuts" v-bind:key="txOut">
